...
/**
 * "3 päivää jäljellä" toteutus on absoluuttinen placeholder! Mukauta
 * android standardien mukaan tallentamista varten + tee siitä styleable
 */
public class ArcProgress extends View {
    ...
    /**
     * Muuta nämä!! Offset tulisi laskea prosenttilukemien alaraeunasta, ei
     * Viewin alareunasta!
     **/
    ...
    private final int default_unfinished_color = R.color.colorPrimaryLightest;
    private final int default_text_color = R.color.colorPrimary;
    private final int default_suffix_color = R.color.colorPrimaryLight;
    ...
    private final float default_bottom_text_offsetx = 0;
    private final float default_bottom_text_offsety = 0;
    ...
    private static final String INSTANCE_SUFFIX_COLOR = "suffix_color";
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedStrokeColor = attributes.getColor(R.styleable.ArcProgress_arc_finished_color, getResources().getColor(default_finished_color));
        unfinishedStrokeColor = attributes.getColor(R.styleable.ArcProgress_arc_unfinished_color, getResources().getColor(default_unfinished_color));
        textColor = attributes.getColor(R.styleable.ArcProgress_arc_text_color, getResources().getColor(default_text_color));
    ...
    protected void initPainters() {
        ...
        paint = new Paint();
        paint.setColor(getResources().getColor(default_unfinished_color));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            textPaint.setColor(textColor);
            textPaint.setTextSize(textSize);
            float textHeight = textPaint.descent() + textPaint.ascent() + textOffsetX;
            float textBaseline = ((getHeight() - textHeight) / 2.0f) + textOffsetY;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putInt(INSTANCE_SUFFIX_COLOR, getSuffixColor());
