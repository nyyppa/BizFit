 ...
 */
public class CustomYAxisRendererBar extends YAxisRenderer {

    private boolean customPaintEnabled;
    private Tracker host;

    public CustomYAxisRendererBar(ViewPortHandler viewPortHandler, YAxis yAxis, Transformer trans, Tracker host) {
